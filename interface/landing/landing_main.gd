...
func _ready():
	...
	$UpgradeStore.connect("player_purchased_upgrade", Client.player_input, "handle_gui_player_ship_upgrade_buy")
	$UpgradeStore.connect("player_sold_upgrade", Client.player_input, "handle_gui_player_ship_upgrade_sell")
